...
const contributionSteps = [
  ...
  { title: 'Upload Your Images', description: 'Use the official competition upload wizard. Make sure to correctly categorize your images and provide a clear, descriptive title and caption.' },
  ...
  return (
    <div className="container mx-auto space-y-12">
      <header className="text-center">
        <h1 className="text-5xl font-headline font-bold text-primary mb-2">How to Contribute</h1>
      ...
      <div className="text-center">
        ...
        <Button asChild size="lg">
          <Link href="https://commons.wikimedia.org/wiki/Category:Images_from_Wiki_Loves_Science_2024_in_India" target="_blank" rel="noopener noreferrer">
