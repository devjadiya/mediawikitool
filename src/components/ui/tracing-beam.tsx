...
export const TracingBeam = ({
  ...
  // track velocity of scroll to increase or decrease distance between svg points
      ...
      <div className="absolute -left-4 md:-left-20 top-3">
        ...
        >
          <motion.div
            ...
            animate={{
              backgroundColor:
                scrollYProgress.get() > 0 ? "hsl(var(--primary))" : "var(--background)",
        ...
        >
          ...
          <defs>
            ...
            >
              ...
              <stop offset="1" stopColor="hsl(var(--chart-4))" stopOpacity="0"></stop>
            </motion.linearGradient>
          </defs>
        </svg>
      </div>
      <div className="[--padding-top:50px]">{children}</div>
    </motion.div>
  );
};
